...
def clear_screen():
    ...
    # Hard reset to clear any login banners (e.g., neofetch/archey)
    try:
        print("c", end="")  # RIS: full terminal reset
    except Exception:
        pass
...
def header(title=None):
    abyss_logo = r"""
         ...
         .8.          8 888888888o `8.`8888.      ,8' d888888o.      d888888o.   
        .888.         8 8888    `88.`8.`8888.    ,8'.`8888:' `88.  .`8888:' `88. 
       :88888.        8 8888     `88 `8.`8888.  ,8' 8.`8888.   Y8  8.`8888.   Y8 
      . `88888.       8 8888     ,88  `8.`8888.,8'  `8.`8888.      `8.`8888.     
     .8. `88888.      8 8888.   ,88'   `8.`88888'    `8.`8888.      `8.`8888.    
    .8`8. `88888.     8 8888888888      `8. 8888      `8.`8888.      `8.`8888.   
   .8' `8. `88888.    8 8888    `88.     `8 8888       `8.`8888.      `8.`8888.  
  .8'   `8. `88888.   8 8888      88      8 8888   8b   `8.`8888. 8b   `8.`8888. 
 .888888888. `88888.  8 8888    ,88'      8 8888   `8b.  ;8.`8888 `8b.  ;8.`8888 
.8'       `8. `88888. 8 888888888P        8 8888    `Y8888P ,88P'  `Y8888P ,88P' 
    """
    print(Fore.CYAN + abyss_logo + Style.RESET_ALL)
    if title:
